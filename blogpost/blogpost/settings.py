...
SECRET_KEY = "django-insecure-y0ood9redgknb$(8#gqc!cifa=_*$4mq*)jw@ko%6#vjk1x7!("
...
REST_FRAMEWORK = {
    ...
    # AnonRateThrottle is used to limit the rate of requests made by unauthenticated users.
...
#when we create a custom user model using AbstractUser. This setting tells Django to use the specified model as the user model for authentication and user management.
